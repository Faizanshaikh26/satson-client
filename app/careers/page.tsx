...
//                     Join a team of passionate innovators working on AI-powered solutions that transform businesses worldwide.
//                 </p>
...
//                                         <h3 className="text-lg font-semibold font-marcellus text-white">
//                                             {job.title}
//                                         </h3>
...
//                                     <div className="flex items-center gap-6 text-sm text-secondaryText font-poppins">
...
//                                     <p className="text-[16px] max-w-4xl text-secondaryText  font-inter leading-relaxed">
//                                         {job.description}
//                                     </p>
...
//                                             Requirements
//                                         </h4>
//                                         <ul className="grid grid-cols-1 font-inter text-secondaryText sm:grid-cols-2 gap-2 text-sm text-secondaryTextlist-disc pl-5">
...
//                 <div className="relative z-10 max-w-3xl mx-auto w-full rounded-2xl bg-gradient-to-b from-[#0b0e18] to-[#07080f] border border-white/10 shadow-[0_40px_120px_rgba(0,0,0,0.6)] p-10 text-center  ">

//                     {/* Emoji */}
//                     <div className="text-3xl mb-6">🤔</div>

//                     {/* Heading */}
//                     <h2 className="text-3xl md:text-[48px] font-semibold text-white">
//                         Don&apos;t See a{" "}
//                         <span className="bg-gradient-to-r from-[#C47DE8] to-[#5593F7] bg-clip-text text-transparent">Perfect Fit?</span>
//                     </h2>

//                     {/* Description */}
//                     <p className="mt-4 text-sm md:text-[20px] font-inter text-secondaryText max-w-xl mx-auto leading-relaxed">
...
//                         <span className="px-6 py-3 rounded-xl border border-purple-500/40 text-sm text-white bg-white/5 backdrop-blur-md">
