...
export default function Portfolio() {
  ...
  useEffect(() => {
    const fetchPortfolios = async () => {
      try {
        ...
        // Assuming API returns { data: Project[] }
  ...
  return (
    <section className="relative overflow-hidden bg-Base pt-20 sm:pt-28 pb-16">
      ...
      {/* Error State */}
      {error && !loading && (
        <div className="relative z-10 max-w-2xl mx-auto py-20 px-4 text-center">
      ...
      {!loading && !error && projects.length === 0 && (
        <div className="relative z-10 max-w-2xl mx-auto py-20 px-4 text-center">
          ...
          <p className="text-gray-400">
            We're currently working on some amazing projects. Check back soon to see our portfolio!
          </p>
        </div>
      )}
